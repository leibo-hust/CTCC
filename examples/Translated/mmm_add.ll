...
block_mmm_0:
  %mat1_middle_0 = getelementptr inbounds [2 x [6 x float]], [2 x [6 x float]]* %b, i64 0, i64 0
  %mat1_0 = getelementptr inbounds [6 x float], [6 x float]* %mat1_middle_0 , i64 0, i64 0
  %mat2_middle_0 = getelementptr inbounds [6 x [5 x float]], [6 x [5 x float]]* %A, i64 0, i64 0
  %mat2_0 = getelementptr inbounds [5 x float], [5 x float]* %mat2_middle_0 , i64 0, i64 0
  %out_middle_0 = getelementptr inbounds [2 x [5 x float]], [2 x [5 x float]]* %c, i64 0, i64 0
  %out_0 = getelementptr inbounds [5 x float], [5 x float]* %out_middle_0 , i64 0, i64 0
  call void @cblas_sgemm(i32 101, i32 111, i32 111, i32 2, i32 5, i32 6, float 1.000000e+00, float* %mat1_0, i32 6, float* %mat2_0, i32 5, float 0.000000e+00, float* %out_0, i32 5)
  br label %for.end22
