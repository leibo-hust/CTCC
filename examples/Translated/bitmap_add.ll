...
block_bitmap_0:
  %vec1_0 = getelementptr inbounds [10 x i32], [10 x i32]* %arr1, i64 0, i64 0
  %vec2_0 = getelementptr inbounds [10 x i32], [10 x i32]* %arr2, i64 0, i64 0
  %out_0 = getelementptr inbounds [10 x i32], [10 x i32]* %arr3, i64 0, i64 0
  call void @CIM_bitmap(i32 10, i32* %vec1_0, i32* %vec2_0, i32* %out_0)
  br label %for.end
